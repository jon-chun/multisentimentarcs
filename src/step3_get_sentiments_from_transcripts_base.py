...
input_dir = "../data/transcripts_combined"
output_dir = "../data/transcripts_sentiments"
...
def main():
    ...
    for file_name in os.listdir(input_dir):
        ...
        if file_name.endswith('.json'):
            ...
            plot_kde(df, ['sentiment-vader_norm', 'sentiment-textblob_norm', 'sentiment-ollama_norm'], film_name=film_name, film_year=film_year, output_dir=output_dir, plot_title="KDE Distributions", file_suffix="_kde_sentiments.png")
